var Q = require('q'),
mongo_service = require('./mongo_service'),
ex_fetcher = require('./ex_fetcher'),
config = require('config'),
worker_config = config.get('worker'),
max_success = worker_config.max_success,
max_error = worker_config.max_error,
success_interval = worker_config.success_interval,
error_interval = worker_config.error_interval;
